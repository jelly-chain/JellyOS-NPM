...
export function text(t: string): ToolContent {
...
// ── Header factory (Pi TUI compat — accepted but rendered by our StatusBar) ───
...
export type SessionEvent =
  | "session_start"       // fired once at TUI startup
  | "session_end"         // fired when the user exits
  | "session_shutdown"    // Pi compat alias for session_end (cleanup)
  | "before_agent_start"; // fired before each model turn
