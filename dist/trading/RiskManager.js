...
export class RiskManager {
    ...
    constructor(positionManager, metrics, limits) {
    ...
    canOpenPosition(symbol, size, leverage, portfolioValue) {
        const violations = [];
        const details = {};
    ...
    checkPortfolioRisk(portfolioValue, initialPortfolioValue) {
        const violations = [];
        const details = {};
    ...
    setLimits(limits) { this.limits = { ...this.limits, ...limits }; }
}
