...
export class LiquidityModel {
    ...
    async analyzeLiquidity(symbol, orderBook, volume24h) {
    ...
    estimateSlippageFromBook(orderBook, tradeSize) {
    ...
    computeLiquidityScore(spread, depth, volume24h, slippage) {
        let score = 0.5;
        if (spread < 0.001)
            score += 0.2;
    ...
    async estimateSlippage(symbol, tradeSize, currentPrice) {
...
//# sourceMappingURL=LiquidityModel.js.map